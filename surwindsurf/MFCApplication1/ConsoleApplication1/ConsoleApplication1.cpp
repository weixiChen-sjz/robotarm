...
// IMPORTANT: This project must be built as Win32 (x86) so it can load EVOC_BPI_DLL.dll (32-bit).
#include "../MFCApplication1/LogManager.h"
#include "../MFCApplication1/LogManager.cpp"
